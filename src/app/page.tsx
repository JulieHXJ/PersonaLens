...
interface AgentEvent {
  ...
  message: string;
  data?: { analysis: WebsiteAnalysis; personas: Persona[] };
  screenshot?: string;
  timestamp: string;
}
...
export default function ConfigureRunPage() {
  ...
  const startRun = () => {
    ...
    localStorage.setItem(
      "nightshift-run",
      JSON.stringify({ analysis, personas: selected, startedAt: new Date().toISOString() })
    );
              ...
              <div className="bg-surface-container-low rounded-xl p-6 border border-outline-variant/10">
                ...
                {screenshots.length > 0 && (
                  <div className="mt-4 pt-4 border-t border-outline-variant/10">
                    <p className="text-[10px] font-mono text-on-surface-variant/60 uppercase mb-3">
